...
public class Game extends Canvas {
    ...
    private long firingInterval = 50;
    ...
    public void gameLoop() {
        ...
        while (gameRunning) {
            ...
            if (waitingForKeyPress) {
                ...
                g.drawString(message, (GAME_WIDTH - g.getFontMetrics().stringWidth(message)) / 2, 250);
                g.drawString("Press any key", (GAME_WIDTH - g.getFontMetrics().stringWidth("Press any key")) / 2, 300);
            }
